...
print "<a href='review.cgi?dbname=Yangkids'><input type='button' value='모든 리뷰 보기' class='button1'></button></a>";
...
sub printTables {
    ...
    my $sql= "SELECT REVIEW.* FROM REVIEW WHERE REVIEW.trans_ID='$trans' ORDER BY REVIEW.reviewDate DESC;";
